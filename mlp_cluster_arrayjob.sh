...
# example usage:
# ```
# EXPT_FILE=experiment.txt  # <- this has a command to run on each line
...
repo_home=/lustre/${USER}/yolov7_carla_object_detection
src_path=${repo_home}/carla

# input data directory path on the scratch disk of the node
dest_path=${SCRATCH_HOME}/yolov7_carla_object_detection/carla
...
src_path=${SCRATCH_HOME}/yolov7_carla_object_detection/output
